...
const terminalLines = [
  ...
  { type: "output", text: "Ваше Имя", delay: 800 },
  { type: "command", text: "cat role.txt", delay: 1600 },
  { type: "output", text: "Frontend-разработчик", delay: 2400 },
  { type: "command", text: "ls skills/", delay: 3200 },
  { type: "output", text: "react/  typescript/  nextjs/  tailwind/", delay: 4000 },
  { type: "command", text: "echo $STATUS", delay: 4800 },
  { type: "output", text: "Открыт к предложениям", highlight: true, delay: 5600 },
]
            ...
            <div className="relative group">
              ...
              <div className="relative bg-card border border-border rounded-2xl p-6 overflow-hidden">
                ...
                <div className="text-center space-y-3">
                  ...
                  <p className="text-primary font-medium">Frontend-разработчик</p>
                ...
                <p className="text-muted-foreground text-sm leading-relaxed text-center">
                  ...
                  Люблю чистый код и новые технологии.
                </p>
                ...
                <div className="mt-5 flex justify-center gap-2">
                  ...
                  <Button variant="outline" size="icon" asChild className="bg-transparent h-9 w-9">
                    <a href="https://t.me/username" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
